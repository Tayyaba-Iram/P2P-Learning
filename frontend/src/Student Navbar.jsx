...
function Navbar() {
    ...
    return (
        <div className="navbar">
            ...
            <Link to="/ScheduleSession" className="SS">Schedule Session</Link>
            <Link to="/superdashboard" className="SS">Super</Link>
            <Link to="/complain-form" className="Complain">Complain</Link>
            <Link to="/admindashboard" className="admin">Admin</Link>
